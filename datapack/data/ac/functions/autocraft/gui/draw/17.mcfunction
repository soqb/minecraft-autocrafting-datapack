...
execute unless data block ~ ~1 ~ Items[{Slot:17b,tag:{ac_gui:1b}}] run data modify block ~ ~1 ~ Items append value {Slot:17b,id:"minecraft:white_stained_glass_pane",Count:1b,tag:{ac_gui:1b,CustomModelData:1b,display:{Name:'{"text":""}'}}}
