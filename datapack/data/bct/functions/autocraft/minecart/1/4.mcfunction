data modify entity @e[tag=bct.hopper_minecart,limit=1] Items[{Slot:1b}].id set from block ~ ~1 ~ Items[{Slot:13b}].id
data modify entity @e[tag=bct.hopper_minecart,limit=1] Items[{Slot:1b}].tag set from block ~ ~1 ~ Items[{Slot:13b}].tag
