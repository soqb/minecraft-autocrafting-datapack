...
data modify entity @s ArmorItems[1].tag.bct_last append value {Slot:3b,id:"minecraft:structure_void",Count:1b,tag:{bct_gui:1b,CustomModelData:2b,display:{Name:'""'}}}
