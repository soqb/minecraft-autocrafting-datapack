...
execute if block ~ ~ ~1 #bct:chest[type=left,facing=east]{Items:[{tag:{bct_locked:1b}}]} positioned ~ ~ ~2 run function bct:fix_items/block
...
execute if block ~ ~ ~1 #bct:chest[type=right,facing=west]{Items:[{tag:{bct_locked:1b}}]} positioned ~ ~ ~2 run function bct:fix_items/block
